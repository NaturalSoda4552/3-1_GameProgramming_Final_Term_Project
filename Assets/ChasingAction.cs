...
namespace Unity.Behavior
{
    ...
    [NodeDescription(name: "chasing", story: "[Agent] nav to [Target] [detected]", category: "Action",
        id: "1b26737c4e2d8b560439040b445fa636")]
    public partial class ChasingAction : Action
    {
        ...
        [SerializeReference]
        public BlackboardVariable<TargetPositionMode> m_TargetPositionMode =
            new(TargetPositionMode.ClosestPointOnAnyCollider);

        [SerializeReference] public BlackboardVariable<GameObject> detected; // 1
        private Mini2_Detecting m; // 2
        ...
        protected override Status OnUpdate()
        {
            ...
            if (m_NavMeshAgent != null)
            {
                ...
                m = detected.Value.GetComponent<Mini2_Detecting>();
                if (!m.isDetected)
                {
                    return Status.Success;
                }
